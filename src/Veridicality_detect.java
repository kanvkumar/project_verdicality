...
public class Veridicality_detect 
{
    ...
    public static void read()
    {
    	...
    	try
        {
    		...
    		FileInputStream fis = new FileInputStream("Lang_Detection/Trigram_20.txt");
    ...
    {
    	System.out.println("inside read_words()");
    	int k=0;
    	try
        {
    		FileInputStream fis = new FileInputStream("Lang_Detection/Words.txt");
            BufferedReader br = new BufferedReader(new InputStreamReader(fis,"UTF-8"));
            String line;
            while((line = br.readLine())!=null)
            {
    ...
    public static void initiate() throws Exception
    {
		read();
		read_words();
	    c = loadModel("Model/RF4.model"); // loads smo model
    }
    public static String lang_tag(String sentence) throws Exception
    {
        ...
        System.out.println("inside lang_tag()");
		for (Map.Entry entry : sorted_map.entrySet()) 
		{
			System.out.println("inside loop of lang_tag");
		...
		str.append("@ATTRIBUTE class        {ct+,ct-,pr+,pr-,uu}\n");
        ...
        for(int i=0;i<words.length;i++)
        {
            ...
            str.append(vector_represent(words[i])+"?\n");
        }
	...
	{
		initiate();
		System.out.println(lang_tag("I love you too"));
	}
}